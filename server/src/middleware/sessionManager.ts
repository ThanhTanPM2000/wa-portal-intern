...
const sessionManager = async (
  ...
  try {
    const PUBLIC_PATHS = ['/api/health', '/api/login', '/api/me', '/webhooks', '/api/account/connectWithCustomerId', '/api/user/customerInitiate', '/api/account/userWithCustomerIdCanceledFacebookFlow', '/api/migration/init', '/api/migration/requestOTP', '/api/migration/verifyCode', '/api/migration/waba'];
