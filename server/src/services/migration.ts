    ...
    for (const migration of migrations) {
        try {
            ...
            await prisma.manager.upsert({
                ...
                update: {},
                create: { state: 'IN_PROGRESS', accountId: account.id, partnerId: migration[0] ? partner.id : null, partnerKeyId: null, creditLineAllocationConfigId, creditLineState: creditLineAllocationConfigId ? CreditLineState.SHARED : CreditLineState.NONE },
            });
